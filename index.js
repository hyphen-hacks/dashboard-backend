...
app.post('/api/v1/newAdminAccount', (req, res) => {
  ...
  console.log(req.headers.origin.substr(0, 15))

  if (req.connection.encrypted || req.headers.host.substr(0, 9) === 'localhost' || req.headers.origin.substr(0, 15) === 'http://localhost') {
